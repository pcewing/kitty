...
class Boss:
    ...
    def drag_resize_start(self, x: float, y: float, cell_width: int, cell_height: int):
        print('kitty/boss.py:Boss.drag_resize_start(x = {}, y = {}, cell_width = {}, cell_height = {})'.format(x, y, cell_width, cell_height))
    ...
    def drag_resize_update(self, x: float, y: float) -> None:
        print('kitty/boss.py:Boss.drag_resize_update(x = {}, y = {})'.format(x, y))
    ...
    def drag_resize_end(self):
        print('kitty/boss.py:Boss.drag_resize_end()')
